            ...
            <div>
                < div className="card">
                    ...
                    <div className="card-body">
                        <h5 className="card-title">{title}...{(new Date().getDate() === new Date(time).getDate()) && ((new Date().getHours() - new Date(time).getHours()) <= 1) ? <span className="badge text-bg-danger">Latest</span> : ""}</h5>
